...
//USER INFO
    ...
    public function addUserInfo(){
        ...
        return view('admin.user_info.create_user_info');
    }
    ...
    public function editUserInfo($id){
        ...
        $editData=UserInfo::find($id);
        return view('admin.user_info.create_user_info',compact('editData'));
    }
